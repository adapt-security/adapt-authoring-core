...
class Config {
   ...
   * Each file maps old key names to new key names (or null if removed). The reserved `_module` key
   * can be used to check a different module section in the user config (for keys that moved between modules).
