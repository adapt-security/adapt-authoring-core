...
class App extends AbstractModule {
  ...
  async loadLibraries () {
    ...
    this.logger = new Logger({
      levels: this.config.get('adapt-authoring-logger.levels'),
      mute: this.config.get('adapt-authoring-logger.mute'),
      dateFormat: this.config.get('adapt-authoring-logger.dateFormat'),
      showTimestamp: this.config.get('adapt-authoring-logger.showTimestamp')
    })
